...
public class API {
    ...
    public static final String GAME_SETTING = "http://api.hdg123.cn/index.php?r=game/setting&package_id=T3&game_id=TEST-DEMO";
...
//    public static final String GAME_ROLE_INFO = "http://api.hdg123.cn/index.php?r=user/rand&game_id=585&package_id=mhzt_01";
    public static final String GAME_ROLE_INFO = "http://api.hdg123.cn/index.php?r=user/rand&game_id=TEST-DEMO&package_id=T3";

    // 向服务器注册
//    public static final String GAME_REGISTER = "http://api.hdg123.cn/index.php?r=user/register&game_id=585&package_id=mhzt_01";
    public static final String GAME_REGISTER = "http://api.hdg123.cn/index.php?r=user/register&game_id=TEST-DEMO&package_id=T3";

    // 用户登录接口
    public static final String GAME_LOGIN = "http://api.hdg123.cn/index.php?r=auth/authorize&UnallowToke=true&game_id=TEST-DEMO&package_id=T3";
//    public static final String GAME_LOGIN = "http://api.hdg123.cn/index.php?r=auth/authorize&UnallowToke=true&game_id=585&package_id=mhzt_01";
    ...
    // 发送手机验证码
    public static final String GAME_VERIFY_CONE = "http://api.hdg123.cn/index.php?r=user/phoneresetkey&game_id=TEST-DEMO&package_id=T3";
//    public static final String GAME_VERIFY_CONE = "http://api.hdg123.cn/index.php?r=user/phoneresetkey&game_id=585&package_id=mhzt_01";
    ...
    // 绑定手机
    public static final String GAME_BIND_PHONE = "http://api.hdg123.cn/index.php?r=user/binding&type=phone&game_id=TEST-DEMO&package_id=T3";
//    public static final String GAME_BIND_PHONE = "http://api.hdg123.cn/index.php?r=user/binding&type=phone&game_id=585&package_id=mhzt_01";
    ...
    // 检查验证码
    public static final String GAME_CHECK_AUTHCODE = "http://api.hdg123.cn/index.php?r=user/checkresetkey&type=PHONE&game_id=TEST-DEMO&package_id=T3";
//    public static final String GAME_CHECK_AUTHCODE = "http://api.hdg123.cn/index.php?r=user/checkresetkey&type=PHONE&game_id=585&package_id=mhzt_01";
    ...
    // 重新去给手机设置发送验证码
    public static final String GAME_RESET_KEY= "http://api.hdg123.cn/index.php?r=user/resetKey&type=USERNAME&game_id=TEST-DEMO&package_id=T3";
//    public static final String GAME_RESET_KEY= "http://api.hdg123.cn/index.php?r=user/resetKey&type=USERNAME&game_id=585&package_id=mhzt_01";
    ...
    // 重置密码
    public static final String GAME_RESET_PSD = "http://api.hdg123.cn/index.php?r=user/resetPassword&type=phone&game_id=TEST-DEMO&package_id=T3";
//    public static final String GAME_RESET_PSD = "http://api.hdg123.cn/index.php?r=user/resetPassword&type=phone&game_id=585&package_id=mhzt_01";
    ...
    // 自动登录
    public static final String GAME_AUTO_LOGIN = "http://api.hdg123.cn/index.php?r=auth/checkaccesstoken&game_id=TEST-DEMO&package_id=T3";
//    public static final String GAME_AUTO_LOGIN = "http://api.hdg123.cn/index.php?r=auth/checkaccesstoken&game_id=585&package_id=mhzt_01";
    ...
    // 检查订单
    public static final String GAME_CHECK_ORDER = "http://api.hdg123.cn/index.php?r=order/check&game_id=TEST-DEMO&package_id=T3";
...
//    public static final String GAME_GET_WECHAT_PARAMS = "http://api.hdg123.cn/index.php?r=order/paylink&payment=wftwx&type=android&game_id=585&package_id=mhzt_01";
    public static final String GAME_GET_WECHAT_PARAMS = "http://api.hdg123.cn/index.php?r=order/paylink&payment=wftwx&type=android&game_id=TEST-DEMO&package_id=T3";

    // 修改密码
    public static final String GAME_UPDATE_PSD = "http://api.hdg123.cn/index.php?r=user/changepassword&game_id=TEST-DEMO&package_id=T3";
